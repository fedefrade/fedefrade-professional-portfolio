...
export const TECHNOLOGIES = [
  ...
  { id: 'lambda', name: 'AWS Lambda', tags: ['Cloud'], experience_time: '3+ years', keywords: ['cloud', 'backend', 'lambda'], devicon: { name: 'amazonwebservices', version: 'plain-wordmark' } },
  { id: 's3', name: 'Amazon S3', tags: ['Cloud'], experience_time: '4+ years', keywords: ['cloud', 'backend', 's3'], devicon: { name: 'amazonwebservices', version: 'plain-wordmark' } },
  { id: 'ebs', name: 'Amazon EBS', tags: ['Cloud'], experience_time: '3+ years', keywords: ['cloud', 'backend', 'ebs'], devicon: { name: 'amazonwebservices', version: 'plain-wordmark' } },
  { id: 'ec2', name: 'Amazon EC2', tags: ['Cloud'], experience_time: '4+ years', keywords: ['cloud', 'backend', 'ec2'], devicon: { name: 'amazonwebservices', version: 'plain-wordmark' } },
  { id: 'glacier', name: 'AWS Glacier', tags: ['Cloud'], experience_time: '3+ years', keywords: ['cloud', 'backend', 'glacier'], devicon: { name: 'amazonwebservices', version: 'plain-wordmark' } },
